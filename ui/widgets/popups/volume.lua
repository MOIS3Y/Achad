...
local vol_icon   = gcrci(icon_dir .. "volume-2.svg", color.scheme.base05)

local volume_osd_height   = dpi(220)
local volume_osd_width    = dpi(220)
local volume_osd_font     = font.volume_osd
...
vol_osd_slider:connect_signal("property::value", function()
    ...
    awful.spawn(
    "pactl set-sink-volume " .. "@DEFAULT_SINK@ " .. volume_level .. "%", false
    )
